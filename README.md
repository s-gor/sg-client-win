...
Справка по темам «Пепел» и «Сталь»: [docs/099K-THEMES-GUIDE.md](docs/099K-THEMES-GUIDE.md).
...
- две новые тёмные темы: нейтральный **Пепел** и холодная **Сталь**;
...
- **Латте**;
- **Север**;
- **Пепел** — спокойный нейтральный серый без выраженной синевы;
- **Сталь** — холодный серо-стальной вариант с более высоким контрастом.

Выбранная тема применяется сразу, сохраняется в настройках и не влияет на соединение, SMART, failover, Kill Switch или маршрутизацию.

Подробности: [справка по темам](docs/099K-THEMES-GUIDE.md).
