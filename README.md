...
Полная справка по политикам, SMART и failover: [docs/099K-POLICIES-GUIDE.md](docs/099K-POLICIES-GUIDE.md).
...
Подробная инструкция: [полная справка по политикам](docs/099K-POLICIES-GUIDE.md).
