...
public class Global
{
    ...
    public const string AppName = "SG Client";
    ...
    public const string ConfigFileName = "sgClientConfig.json";
    ...
    public const string InnerUriProtocol = "sgclient://";
    ...
    public const string AutoRunName = "SGClientAutoRun";
    ...
    public const string LocalAppData = "SG_CLIENT_LOCAL_APPLICATION_DATA";
